...
export default function TabBar({ activeTab, onSetTab, theme, onToggleTheme, windowMode, onToggleMode, sidebarCollapsed, onToggleSidebar, onOpenSync, onOpenSettings }: TabBarProps) {
  return (
